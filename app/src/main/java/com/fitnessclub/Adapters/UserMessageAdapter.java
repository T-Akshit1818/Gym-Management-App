...
public class UserMessageAdapter extends RecyclerView.Adapter<UserMessageAdapter.MessagesViewHolder> {

    private final Context context;

    public UserMessageAdapter(List<MessagePojo> msg, String from, Context context){
        this.from=from;
        this.context=context;
        this.msg=msg;

    }
    List<MessagePojo> msg;
    String from;
    @NonNull
    @Override
