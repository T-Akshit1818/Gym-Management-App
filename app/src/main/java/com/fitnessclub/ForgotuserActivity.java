    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btngetpassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Call<SuccessOrFailureResponse> reg= ServiceGenerator.getGymApi().forgotuser(textEmailAddress.getText().toString());
                    reg.enqueue(new Callback<SuccessOrFailureResponse>() {
                        ...
                        public void onResponse(Call<SuccessOrFailureResponse> call, Response<SuccessOrFailureResponse> response) {
                            if (response.body().getStatus().equals("true")) {
                                Intent s=new Intent(ForgotuserActivity.this,LoginActivity.class);
                                startActivity(s);
                                Toast.makeText(ForgotuserActivity.this, response.body().getMessage(), Toast.LENGTH_LONG).show();
                        ...
                        public void onFailure(Call<SuccessOrFailureResponse> call, Throwable t) {
                            Toast.makeText(ForgotuserActivity.this, t.toString(), Toast.LENGTH_LONG).show();
